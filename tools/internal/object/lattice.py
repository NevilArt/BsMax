...
class Lattice_OT_Set_On_Selection(Operator):
	...
	res_u: IntProperty(name="Res X", min=2, max=1000, default=2) # type: ignore
	res_v: IntProperty(name="Res Y", min=2, max=1000, default=2) # type: ignore
	res_w: IntProperty(name="Res Z", min=2, max=1000, default=2) # type: ignore

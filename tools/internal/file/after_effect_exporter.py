...
# original coder developed by "Bartek Skorupa, Damien Picard
# I fund it with 2 year not updated and deside to put it on BsMax and keep it update
...
def object_export_get_prop_keyframe(self, prop_name, value, time):
...
def object_export_get_keyframe(self, width, height, aspect, time, ae_size):
...
def object_export_get_obj_script(self, include_animation):
	"""Get the JSX script for the object"""
	script = self.get_type_script()
	script += self.get_anim_script(include_animation)
	script += self.get_post_script()
	return script



def object_export_get_type_script(self):
...
def object_export_get_anim_script(self, include_animation):
...
def camera_export_get_keyframe(self, width, height, aspect, time, ae_size):
	ae_transform = convert_transform_matrix(self.obj.matrix_world,
											width, height, aspect, ae_size)
...
def camera_export_get_type_script(self):
...
def light_export_get_keyframe(self, width, height, aspect, time, ae_size):
	ae_transform = convert_transform_matrix(self.obj.matrix_world,
											width, height, aspect, ae_size)
...
def light_export_get_type_script(self):
...
def light_export_get_post_script(self):
...
def image_export_get_keyframe(self, width, height, aspect, time, ae_size):
...
def image_export_get_type_script(self):
...
def solid_export_get_keyframe(self, width, height, aspect, time, ae_size):
	# Convert obj transform properties to AE space
...
def solid_export_get_type_script(self):
...
def cam_bundle_export_get_keyframe(self, width, height, aspect, time, ae_size):
...
def cam_bundle_export_get_type_script(self):
	type_script = f'var {self.name_ae} = newComp.layers.addNull();\n'
	type_script += f'{self.name_ae}.threeDLayer = true;\n'
	type_script += f'{self.name_ae}.source.name = "{self.name_ae}";\n'
	return type_script
...
class ObjectExport():
	...
	def get_prop_keyframe(self, prop_name, value, time):
		object_export_get_prop_keyframe(self, prop_name, value, time)

	def get_keyframe(self, context, width, height, aspect, time, ae_size):
		object_export_get_keyframe(self, width, height, aspect, time, ae_size)

	def get_obj_script(self, include_animation):
		return object_export_get_obj_script(self, include_animation)

	def get_type_script(self):
		return object_export_get_type_script(self)

	def get_anim_script(self, include_animation):
		return object_export_get_anim_script(self, include_animation)
...
class CameraExport(ObjectExport):
	...
	def get_keyframe(self, context, width, height, aspect, time, ae_size):
		camera_export_get_keyframe(self, width, height, aspect, time, ae_size)

	def get_type_script(self):
		return camera_export_get_type_script(self)



class LightExport(ObjectExport):
	def get_keyframe(self, context, width, height, aspect, time, ae_size):
		light_export_get_keyframe(self, width, height, aspect, time, ae_size)

	def get_type_script(self):
		return light_export_get_type_script(self)

	def get_post_script(self):
		return light_export_get_post_script(self)



class ImageExport(ObjectExport):
	def get_keyframe(self, context, width, height, aspect, time, ae_size):
		image_export_get_keyframe(self, width, height, aspect, time, ae_size)

	def get_type_script(self):
		return image_export_get_type_script(self)



class SolidExport(ObjectExport):
	def get_keyframe(self, context, width, height, aspect, time, ae_size):
		solid_export_get_keyframe(self, width, height, aspect, time, ae_size)

	def get_type_script(self):
		return solid_export_get_type_script(self)
...
class CamBundleExport(ObjectExport):
	...
	def get_keyframe(self, context, width, height, aspect, time, ae_size):
		cam_bundle_export_get_keyframe(self, width, height, aspect, time, ae_size)

	def get_type_script(self):
		return cam_bundle_export_get_type_script(self)



##########################################
# File_TO_AfterEffect_JSX_Exporter class register/unregister
##########################################
class File_TO_AfterEffect_JSX_Exporter(Operator, ExportHelper):
	"""Export selected cameras and objects animation to After Effects"""
	bl_idname = "file.export_to_after_effect"
	bl_label = "Export to Adobe After Effects (*.JSX)"
...
def menu_func(self, ctx):
	self.layout.operator(
		File_TO_AfterEffect_JSX_Exporter.bl_idname,
		text="Adobe After Effects (.jsx)"
	)


def register_after_effect_exporter():
	bpy.utils.register_class(File_TO_AfterEffect_JSX_Exporter)
	bpy.types.TOPBAR_MT_file_export.append(menu_func)


def unregister_after_effect_exporter():
	bpy.utils.unregister_class(File_TO_AfterEffect_JSX_Exporter)

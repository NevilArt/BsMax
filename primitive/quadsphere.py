		...
		for y in range(segments):
			for z in range(segments):
				...
				if x == 0: #Bottom
					faces.append(
						(
							vertIndex[0], vertIndex[2],
							vertIndex[6], vertIndex[4]
						)
					)
				...
				if y == segments - 1: #Back
					faces.append(
						(
							vertIndex[2], vertIndex[3],
							vertIndex[7], vertIndex[6]
						)
					)
				...
				if z == 0: #left
					faces.append(
						(
							vertIndex[0], vertIndex[1],
							vertIndex[3], vertIndex[2]
						)
					)

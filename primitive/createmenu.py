...
class BsMax_MT_LatticeCreate(Menu):
	...
	def draw(self, ctx):
		layout = self.layout
		layout.operator("bsmax.createlattice", text='Lattice 2x2x2',
						icon="OUTLINER_OB_LATTICE").resolution = 2
		layout.operator("bsmax.createlattice", text='Lattice 3x3x3',
						icon="OUTLINER_OB_LATTICE").resolution = 3
		layout.operator("bsmax.createlattice", text='Lattice 4x4x4',

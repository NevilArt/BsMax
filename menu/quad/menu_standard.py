...
def get_view3d_transform(ctx):
	...
	items.append(QuadItem("Align Objects...", f,
				(len(ctx.selected_objects) > 0), n, c0144, n))
	items.append(seprator())
...
def get_view3d_tool2(ctx):
	...
	if get_active_type(ctx) == 'MESH':
		...
		items.append(seprator())
		items.append(QuadItem("Lock Camera to View",
								ctx.space_data.lock_camera, t, n, c0162, n))

		items.append(QuadItem("Lock to 3D Cursor",
								ctx.space_data.lock_cursor, t, n, c0163, n))
